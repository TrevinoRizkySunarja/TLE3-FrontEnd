...
const dummyUserData = {
    ...
    drivers_license_expiry: '2028-06-17',
    greenpass_expiry: '2027-09-01',
    parking_permit_expiry: '2026-12-31',
    milieupas_expiry: '2028-03-15',
};
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B] font-medium">
                                {dummyUserData.first_name} {dummyUserData.last_name}
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{dummyUserData.email}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{dummyUserData.phone_number}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">
                                {formatDate(dummyUserData.birth_date)}
                            </span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B] font-mono">{dummyUserData.bsn}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">
                                {formatGender(dummyUserData.gender)}
                            </span>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-[#F9F9FF] border border-[#E0E0E0] rounded-[5px] p-6 md:p-8 shadow-sm mb-6">
                    ...
                    <div className="space-y-6">
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{formatDate(dummyUserData.passport_expiry)}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{formatDate(dummyUserData.drivers_license_expiry)}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{formatDate(dummyUserData.greenpass_expiry)}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 pb-4 border-b border-[#E0E0E0]">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{formatDate(dummyUserData.milieupas_expiry)}</span>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                            ...
                            <span className="text-[16px] text-[#1B1B1B]">{formatDate(dummyUserData.parking_permit_expiry)}</span>
                        </div>
                    </div>
                </section>
