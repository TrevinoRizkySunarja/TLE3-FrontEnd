...
export default function Navbar() {
    ...
    return (
        <nav role="navigation" className="fixed top-0 left-0 right-0 z-50 bg-[#FFFFFF] border-b border-[#E0E0E0] pt-4 pb-6 px-4 font-['Arial',sans-serif]" aria-label="Hoofdnavigatie Gemeente CMGT">
            <div className="max-w-7xl mx-auto flex items-center justify-between">

                {/* LOGO SECTIE */}
                <div className="flex items-center">
                    <Link to="/" aria-label="Ga naar Mijn CMGT overzicht">
                ...
                <div className="hidden md:flex flex-wrap gap-2">
                    ...
                    {/* Aangepast naar belastingen i.v.m. de route */}
                    <Link to="/belasting" className={blackBtnStyle}>
                        <Inbox size={20} aria-hidden="true" />
                        <span>Mijn Belastingen</span>
                    </Link>

                    {/* Specifiek voor gemeente-termen (Melding Openbare Ruimte) */}
                    <Link to="/artikel" className={blackBtnStyle}>
                        <PlusSquare size={20} aria-hidden="true" />
                        <span>Nieuwe Melding</span>
                    </Link>

                    {/* Gemeentes hebben vaak een 'Algoritmeregister' */}
                    <Link to="/ai-transparantie" className={blackBtnStyle} aria-label="Algoritmeregister Gemeente CMGT" title="Algoritmeregister Gemeente CMGT">
                        <Cpu size={20} aria-hidden="true" />
                        <span>Algoritmeregister</span>
                    </Link>
                ...
                <div className="md:hidden">
                    <button
                        ...
                        aria-label={mobileOpen ? 'Sluit navigatie' : 'Menu Gemeente CMGT'}
                    ...
                    {mobileOpen && (
                        <div
                            ...
                            id="mobile-menu"
                            role="menu"
                            aria-label="Mobiele navigatie Gemeente CMGT"
